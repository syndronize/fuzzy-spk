		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li>
						<a href="{{route('gejala.index')}}" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-bug"></span><span class="mtext">Gejala</span>
						</a>
					</li>
					<li>
						<a href="{{route('diagnosis.index')}}" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-binocular"></span><span class="mtext">Diagnosis</span>
						</a>
					</li>
					<li>
						<a href="{{route('diagnosisgejala.index')}}" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-notepad-1"></span><span class="mtext">Diagnosis Gejala</span>
						</a>
					</li>
	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			...
			<div class="footer-wrap pd-20 mb-20 card-box">
				Copyright ©️ @php echo date("Y") @endphp  - All rights reserved. 
			</div>
		</div>
	</div>
	<!-- js -->
